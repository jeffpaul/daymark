...
- The full-screen post view lost the site title, date, and interaction icons (Like through Share) a Timeline card already shows once opened — they're now kept visible above the post's own content. ([#287](https://github.com/jeffpaul/daymark/issues/287))
