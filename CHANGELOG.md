...
- A Timeline card's comment/like/repost stat row is now ordered like, comment, reblog (was comment, like, repost). ([#185](https://github.com/jeffpaul/daymark/pull/185))
