<?php
/**
 * Server render for the daymark/timeline dynamic block.
 *
 * Delegates to the shared Daymark_Renderer so the block and the
 * [daymark_timeline] shortcode produce identical markup.
 *
 * @package Daymark
 *
...
$daymark_wrapper_attributes = get_block_wrapper_attributes( array( 'class' => 'daymark-view daymark-view--timeline' ) );
