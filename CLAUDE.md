...
| Brand colors | Purples: primary `#7A00DF`, deep `#5300BE`, light `#D7A7FF`, transparent `rgba(122, 0, 223, 0.12)` | Documented in [docs/brand.md](docs/brand.md) and applied throughout the app shell (`--daymark-accent*` custom props), views, manifest, theme-color, and icon. |
